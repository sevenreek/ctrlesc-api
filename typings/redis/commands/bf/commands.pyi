...
class BFCommands:
    ...
    def create(self, key, errorRate, capacity, expansion=..., noScale=...):
        """
    ...
    def insert(self, key, items, capacity=..., error=..., noCreate=..., expansion=..., noScale=...):
        """
        Add to a Bloom Filter `key` multiple `items`.
...
class CFCommands:
    ...
    def create(self, key, capacity, expansion=..., bucket_size=..., max_iterations=...):
        """
    ...
    def insert(self, key, items, capacity=..., nocreate=...):
        """
    ...
    def insertnx(self, key, items, capacity=..., nocreate=...):
        """
...
class TDigestCommands:
    ...
    def merge(self, destination_key, num_keys, *keys, compression=..., override=...):
        """
