...
class Lock:
    ...
    def __init__(self, redis, name: str, timeout: Optional[Number] = ..., sleep: Number = ..., blocking: bool = ..., blocking_timeout: Optional[Number] = ..., thread_local: bool = ..., raise_on_release_error: bool = ...) -> None:
        """
    ...
    def extend(self, additional_time: Number, replace_ttl: bool = ...) -> bool:
        """
