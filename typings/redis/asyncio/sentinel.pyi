...
class SentinelManagedConnection(Connection):
    ...
    async def read_response(self, disable_decoding: bool = ..., timeout: Optional[float] = ..., *, disconnect_on_error: Optional[float] = ..., push_request: Optional[bool] = ...): # -> None:
        ...
...
class Sentinel(AsyncSentinelCommands):
    ...
    async def execute_command(self, *args, **kwargs): # -> list[Any | None] | bool:
        """
