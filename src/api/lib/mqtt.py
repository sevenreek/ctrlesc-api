...
def on_connect(client: MQTTClient, flags, rc, properties: dict[str, Any]):
    print("MQTT Connected")


def on_message(client: MQTTClient, topic: str, payload: bytes, qos: int, properties: dict[str, Any]):
